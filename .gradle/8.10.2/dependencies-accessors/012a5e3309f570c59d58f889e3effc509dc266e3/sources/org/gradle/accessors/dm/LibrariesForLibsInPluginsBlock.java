...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinPluginAccessors extends PluginFactory {
        private final KotlinSymbolPluginAccessors paccForKotlinSymbolPluginAccessors = new KotlinSymbolPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.kotlin.symbol</b>
         */
        public KotlinSymbolPluginAccessors getSymbol() {
            return paccForKotlinSymbolPluginAccessors;
        }

    }

    public static class KotlinSymbolPluginAccessors extends PluginFactory {

        public KotlinSymbolPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>kotlin.symbol.processing</b> with plugin id <b>com.google.devtools.ksp</b> and
         * with version reference <b>ksp</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getProcessing() { return createPlugin("kotlin.symbol.processing"); }
